...
public class CalendarPickerView extends StickyListHeadersListView {
  ...
  private class MonthAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    ...
    @Override public View getHeaderView(int position, View convertView, ViewGroup parent) {
	  ...
	  if (convertView == null) {
		  ...
		  convertView = inflater.inflate(R.layout.month_header, parent, false);
		  holder.text = (TextView) convertView.findViewById(R.id.header);
		  convertView.setTag(holder);
	  } else {
		  holder = (HeaderViewHolder) convertView.getTag();
	  }
	  String headerText = months.get(position).getLabel();
